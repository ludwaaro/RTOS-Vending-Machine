 ...
 * THIS_IS_STACK_APPLICATION is defined)*/
    ...
    #pragma config FWDTEN = OFF, FPBDIV = DIV_8, POSCMOD = XT, FNOSC = PRIPLL
    #pragma config CP = OFF
/* external PHY in RMII/alternate configuration */
    #pragma config FMIIEN = OFF, FETHIO = ON, ICESEL = ICS_PGx1, DEBUG = ON
#endif



/* Clock frequency values: These directly influence timed events using the
 * Tick module.  They also are used for UART and SPI baud rate generation.*/
...
// Ports and bits modified for Cerebot MX7cK - RWW
...
// Cerebot 32MX7
#define LED_GET()	(unsigned char)( ((LATG & LED_1_4) >> 12) |\
                                         ((LATB & LED_A_C) << 2)  |\
                                         (((LATB&&LED_D_H)<<1)) )
/* Directs 12 bit value to LED 1 - 4 and LED A - H,  RWW Cerebot MX7cK */
#define LED_PUT(a)	do{LATGCLR = (LED_1_4);\
                           LATGSET = ((a << 12) & LED_1_4);\
                           LATBCLR = LED_A_H;\
                           LATBSET = (((a & 0x70) >> 2) & LED_A_H);\
                           LATBSET = (((a&0x0F80)>>1)& LED_A_H); }while(0)
...
#define BUTTON3_TRIS	(TRISAbits.TRISA0)	// No BUTTON3 on this board 
#define BUTTON3_IO	(TRISAbits.TRISA0)      // - Use BTN3
...
#define	PHY_ADDRESS	0x0	/* The logical address of the SMC LAN8720 PHY */
...
#endif /* End of #ifndef HARDWARE_PROFILE_H */
